...
impl SecureRandom for CoreCryptoRandom {
    ...
    fn fips(&self) -> bool {
        // True FIPS claim depends on macOS version ↔ corecrypto cert.
        // Reporting `true` here advertises the *intent* to rustls; consumers
        // should still verify CMVP OE coverage for the running OS.
        true
    }
}
