...
//! [`modkit::ProtoBridge`], which auto-generates `From`/`Into` between the
...
#[cfg_attr(feature = "grpc-client", derive(modkit::ProtoBridge))]
#[cfg_attr(
    feature = "grpc-client",
...
impl ChargeRequest {
    ...
    #[must_use]
    pub fn new(amount_cents: i64, currency: impl Into<String>, description: impl Into<String>) -> Self {
        Self {
            amount_cents,
